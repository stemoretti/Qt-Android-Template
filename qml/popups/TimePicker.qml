...
Popup {
    ...
    property int timePickerWidth: isLandscape ? appWindow.width * 0.85 : appWindow.width * 0.9
    property int timePickerHeight: isLandscape ? appWindow.height * 0.90 : appWindow.height * 0.9
    ...
    y: (parent.height - timePickerHeight) / 2 - 24
    ...
    Pane {
        ...
        Repeater {
            ...
            delegate: Button {
                id: outerButton
                focusPolicy: Qt.NoFocus
                text: timePicker.pickMinutes? modelData.m : modelData.c1
//                font.bold: checked
                ...
                contentItem: Label {
                    ...
                    color: outerButton.checked || outerButton.highlighted ? textOnPrimary : "black"
                    horizontalAlignment: Text.AlignHCenter
                    verticalAlignment: Text.AlignVCenter
                    elide: Text.ElideRight
